...
class CurrencyUtils {
  ...
  /// After update config, don't forget to update `AppInfor.lastCompany` as well
  static NumberConfig numberConfig = NumberConfig();
  ...
  static convertNumberFormat(int cost){
    return NumberFormat('#,###').format(cost).replaceAll(',', '.');
  }
